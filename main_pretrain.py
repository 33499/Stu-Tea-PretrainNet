...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='./output_dir_base_h_medical_22_new_cls_position',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir_base_h_medical_22_new_cls_positon',
                        help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda:0',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)
    parser.add_argument('--resume', default='output_dir_base_h_medical_22_new_cls_position/checkpoint-latest.pth',
